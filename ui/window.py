...
class MainWindow(QMainWindow):
    ...
    def update_ui(self,data):
        ...
        self.net_panel.update_net(data.net_download_speed,data.net_upload_speed,data.net_total_recv,data.net_total_sent,data.net_ping,data.errors_per_sec,data.total_errors,data.drops_per_sec,data.total_drops)
